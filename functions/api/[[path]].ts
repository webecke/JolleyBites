...
// import { handleIngredientsRequest } from '../../src/backend/handlersOld/ingredientsHandler'
...
// import { handleRecipesRequest } from '../../src/backend/handlersOld/recipesHandler'
//
// /*
...
//   env.dataAccess = dataAccessMachine
//
//   if (env.user == null) { throw ServerError.unauthorized("AuthToken invalid") }
//
...
// }
//
// async function getUserFromAuth(authToken: string, dataAccessMachine: DataAccessMachine): Promise<any> {
